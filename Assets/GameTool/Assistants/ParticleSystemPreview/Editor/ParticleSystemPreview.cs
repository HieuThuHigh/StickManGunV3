...
namespace GameTool.Assistants.ParticleSystemPreview.Editor
{
    public class ParticleSystemPreview : ObjectPreview
    {
        ...
        private static Vector2 m_PreviewDir = new Vector2(0f, 0f);

        // private Vector2 m_PreviewDir = new Vector2(120f, -20f);
        private Mesh m_FloorPlane;
        private Texture2D m_FloorTexture;
        private Material m_FloorMaterial;
        private static float m_AvatarScale = 1f;
        private static float m_ZoomFactor = 1f;
        private static Vector3 m_PivotPositionOffset = Vector3.zero;
        private static float m_BoundingVolumeScale;
        ...
        private static readonly int AlphasShaderID = Shader.PropertyToID("_Alphas");

        public Vector3 bodyPosition => m_PreviewInstance.transform.position;
        ...
        private void InitPreview()
        {
            ...
            if (m_FloorMaterial == null)
            {
                ...
                {
                    mainTexture = m_FloorTexture, mainTextureScale = Vector2.one * (5f * 4f)
                };
                m_FloorMaterial.SetVector(AlphasShaderID, new Vector4(0.5f, 0.3f, 0f, 0f));
        ...
        private bool HasStaticPreview()
        {
            ...
            return gameObject is { } && gameObject.GetComponentInChildren<ParticleSystem>(true);
        }
        ...
        private void DoRenderPreview()
        {
            ...
            PositionPreviewObjects(pivotRot, pivotPos, quaternion2, bodyPos, directionRot, quaternion, vector, directionPos, m_AvatarScale);
            ...
            Vector3 position2 = rotation * Vector3.forward * (-5.5f * m_ZoomFactor) + bodyPos + m_PivotPositionOffset;
            ...
            floorMaterial.SetVector(AlphasShaderID, new Vector4(0.5f * 1f, 0.3f * 1f, 0f, 0f));
        ...
        private void CreatePreviewInstances()
        {
            ...
            m_AvatarScale = (m_ZoomFactor = m_BoundingVolumeScale);
        ...
        public void DoAvatarPreviewOrbit(Event evt, Vector2 dir)
        {
            m_PreviewDir = dir;
            m_PreviewDir.y = Mathf.Clamp(m_PreviewDir.y, -90f, 90f);
            evt.Use();
